...
6. Read and follow `/home/amol/code/nori/nori-browser/.worktrees/slim-tea-20260606-205428/.claude/skills/building-user-interface-elements/SKILL.md` to properly take the finished design and implement it.
</required>
