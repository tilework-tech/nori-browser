...
5. Check the scope. Verify that the ask is good for a skillset.
  ...
  - If too specific, ask me if I want to make a skill instead. If so, use `/home/amol/code/nori/nori-browser/.worktrees/vast-fig-20260606-210853/.claude/skills/creating-skills/SKILL.md`.
...
8. If I identified specific subprocesses that should be skills, create those skills using the `/home/amol/code/nori/nori-browser/.worktrees/vast-fig-20260606-210853/.claude/skills/creating-skills/SKILL.md` skill.
...
// 'if condition, read and follow  `/home/amol/code/nori/nori-browser/.worktrees/vast-fig-20260606-210853/.claude/skills/{skill name}/SKILL.md`'
// 'do abc'
</required>
