...
allowed-tools: Bash(node /home/amol/code/nori/nori-browser/.worktrees/able-bee-20260606-204928/.claude/skills/nori-sync-docs/script.js:*)
---
...
```bash
node /home/amol/code/nori/nori-browser/.worktrees/able-bee-20260606-204928/.claude/skills/nori-sync-docs/script.js
```
